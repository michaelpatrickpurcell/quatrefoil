...
%\cfoot*{\hfill
%\begin{tabular}{@{}m{\columnwidth/2-\widthof{\Huge{\doclicenseIcon}}-0.5cm}@{\hspace{0.05cm}}m{\widthof{\Huge{\doclicenseIcon}}}@{}}
%{This work is licensed under a\newline ``CC BY 4.0'' license.} & \Huge{\doclicenseIcon}\\
%\end{tabular}
%}
%\cfoot*{\normalshape \doclicenseText \hfill\Huge \doclicenseIcon}
\makeatother
